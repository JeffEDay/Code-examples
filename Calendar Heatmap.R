...
# DAU needs to be changed to run to appropriate field name
...
df <- df[, c("year", "yearmonthf", "monthf", "week", "monthweek", "Day_of_week", "DAU")]
head(df)
...
# Plot
ggplot(df, aes(monthweek, Day_of_week, fill = DAU)) + 
